...
public class CreateInitialTables : Migration {
    public override void Up()
    {
        Create.Table("report_requests")
            .WithColumn("request_id").AsInt64().PrimaryKey().Identity()
            .WithColumn("product_id").AsInt64().NotNullable()
            .WithColumn("checkout_id").AsInt64().NotNullable()
            .WithColumn("period_from").AsDateTime().NotNullable()
            .WithColumn("period_to").AsDateTime().NotNullable()
        ...
        Create.ForeignKey("fk_report_results_request")
            ...
            .ToTable("report_requests").PrimaryColumn("request_id")
